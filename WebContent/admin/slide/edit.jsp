			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="page-header">
						<h2 class="pageheader-title">Sửa slide</h2>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									...
									%>
									<form role="form"
										action="<%=request.getContextPath()%>/admin/slide/edit?id=<%=objSlide.getId()%>"
				...
				out.print(name);%>"
										...
										<div class="form-group">
											...
											<%
												if (!picture.isEmpty()) {
											%>
											<br /> <img width="390px" height="130px" id="img"
												alt="hinhanh"
										...
										<div class="form-group">
											<label for="link">Link</label> <input id="link"
												class="form-control" name="link"
												value="<%if (link != null)
				out.print(link);%>" />
										</div>
										<div class="form-group">
											<label for="location">Vị trí</label> <input
