			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="page-header">
						<h2 class="pageheader-title">Quản lý slide</h2>
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="table-responsive">
								<div class="row">
									<div class="col-sm-6">
										<a href="<%=request.getContextPath()%>/admin/slide/add"
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												...
												%> <img width="360px"
												height="120px"
												src="<%=request.getContextPath()%>/files/<%=objSlide.getPicture()%>"
												alt="<%=objSlide.getName()%>" /> <%
 	} else {
 %> <img width="177px"
												height="120px"
										...
										<div class="dataTables_paginate paging_simple_numbers"
											...
											<ul class="pagination">
												...
												<li class="paginate_button<%=active%>"
													...
													href="<%=request.getContextPath()%>/admin/slide/index/page-<%=i%>"><%=i%></a></li>
												<%
													}
												%>
												<%
