                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                        	...
                                        	%>
												<img width="360px" height="120px" src="<%=request.getContextPath() %>/files/<%=objSlide.getPicture() %>" alt="<%=objSlide.getName() %>"/>
                                        	<%
                                        		} else {
                                        	%>
                                        ...
                                        <ul class="pagination">
                                        	<%
	                                    		...
	                                    		if (currentPage == 1) {
	                                    			...
	                                    			urlPre = request.getContextPath() + "/admin/slide/index/page-" + (currentPage - 1);
	                                    		}
                                        	%>
                                        	...
                                        	%>
                                            <li class="paginate_button<%=active %>" aria-controls="dataTables-example" tabindex="0"><a href="<%=request.getContextPath()%>/admin/slide/index/page-<%=i%>"><%=i%></a></li>
                                            <%} %>
                                            <%
                                            	String urlNext = "";
                                        		if (currentPage == numberOfPages) {
                                        			...
                                        			urlNext = request.getContextPath() + "/admin/slide/index/page-" + (currentPage + 1);
                                        		}
                                        	%>
