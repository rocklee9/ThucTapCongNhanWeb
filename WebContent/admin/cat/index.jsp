                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="table-responsive">
                            <div class="row">
                                ...
                                <div class="col-sm-6" style="text-align: right;">
                                    <form method="post" action="">
                                        ...
                                        <input type="search" required="required" class="form-control input-sm" placeholder="Nhập tên danh mục" style="float:right; width: 300px;" />
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="dataTables-example_info" style="margin-top:27px">Hiển thị từ <%=begin%> đến <%=end %> của <%=numberOfItems%> danh mục</div>
                                </div>
                                <div class="col-sm-6" style="text-align: right;">
