                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
								...
								<%} %>
                                <form role="form" action="<%=request.getContextPath()%>/admin/song/edit?sid=<%=objSong.getId()%>" method="post" enctype="multipart/form-data" id="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <% if (!picture.isEmpty()) {%>
                                        <br />
                                        <img width="200px" height="130px" id="img" alt="hinhanh" src="<%=request.getContextPath()%>/files/<%=picture%>" >
                                        <br />
                                        <%} else {%>
                                        <br />
                                        <img width="200px" height="130px" id="img" alt="hinhanh" src="<%=request.getContextPath() %>/templates/admin/assets/img/no.gif" >
                                        <br />
                                        <%}%>
                                    </div>
                                    <div class="form-group">
