                        ...
                        <div class="table-responsive">
                            <div class="row">
                                ...
                                <div class="col-sm-6" style="text-align: right;">
                                    <form method="post" action="<%=request.getContextPath()%>/searchSong">
                                        <input type="submit" name="search" value="Tìm kiếm" class="btn btn-warning btn-sm" style="float:right" />
                                        <input type="search" name="textSearch" class="form-control input-sm" placeholder="Nhập tên bài hát" required="required" style="float:right; width: 300px;" />
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                        	...
                                        	%>
												<img width="177px" height="120px" src="<%=request.getContextPath() %>/files/<%=objSong.getPicture() %>" alt="<%=objSong.getSongName() %>"/>
                                        	<%
                                        		} else {
                                        	%>
                                        		<img width="177px" height="120px" src="<%=request.getContextPath() %>/templates/admin/assets/img/no.gif" />
                                        	<%} %>
                                        </td>
                                        <td class="text-center">
                                        	<a href="javascript:void(0)" ><img id="<%=objSong.getId() %>" src="<%=request.getContextPath()%>/templates/admin/assets/img/active.gif" alt="" /></a>
                                        </td>
                                        <td class="text-center">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <% } else { %>
                                        <td class="text-center">
                                        	<a href="javascript:void(0)" ><img id="<%=objSong.getId() %>" src="<%=request.getContextPath()%>/templates/admin/assets/img/deactive.gif" alt="" /></a>
                                        </td>
                                        <%} %>
                                        <td class="text-center">
                                            <a href="<%=urlEdit %>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="dataTables-example_info" style="margin-top:27px">Hiển thị từ <%=begin%> đến <%=end %> của <%=numberOfItems%> bài hát</div>
                                </div>
                                <div class="col-sm-6" style="text-align: right;">
