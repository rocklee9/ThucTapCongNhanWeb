...
<!-- Start phần code project cũ -->
	<div class="content_resize " style="margin: 0 8%">
	  <div class="mainbar">
	  	<%
		      ...
		      <div class="single-blog-post post-style-4 d-flex align-items-center wow fadeInUpBig " data-wow-delay="0.2s">
			      <div class="row">
			      	 <div class="post-thumbnail col-md-3">
				      	<a href="<%=urlDetail%>">
				      		<img src="<%=request.getContextPath()%>/files/<%=song.getPicture()%>" width="177" height="177" alt="" class="userpic" />
				      	</a>
			      	</div>
			      	<div class="post-content col-9">
				        <h2><a href="<%=urlDetail%>" class="headline"><%=song.getSongName()%></a></h2>
	    ...
	    <div class="article">
	    	...
	    	<form class="form-cmt">
				...
				<div class="form-item">
					<textarea name="cmt" id="cmt" placeholder="Nhập bình luận..." required="required"></textarea>
